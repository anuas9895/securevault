...
from app_securevault.models import Sign_in,Sign_up,HealthRecord,FinancialDetails,EducationalDetails
...
def profile_data(request):
    ...
    return render(request, 'userdata.html', {'profiledata': data})
